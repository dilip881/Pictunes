...
client_id = "778b7ad3e55f4679a59fd0cd7bd4481a"
client_secret = "a9b712ba6b174dbdae401dff23ab3638"
...
root = tk.Tk()
root.title('Pictunes Form')
root.geometry("1920x1080")
root.configure(bg='black')
name1 = tk.StringVar()
image_path = "./images/musicback.jpg"
...
name_entry = tk.Entry(root,
                      textvariable=name1, font=('calibre', 20, 'normal'))
...
message = tk.Label(
    window, text="PICTUNES - Music Recommender System",
...
image1_path = "./images/musicimg (1).jpg"
